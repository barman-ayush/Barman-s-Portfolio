        ...
        <Fragment>
            <div className="contact-card-landing border-2 border-slate-500 px-4 py-4" style={{width : ""}}>
                ...
                <div className="contact-list mt-4">
                    <a href="" className="discord-link hover:opacity-100 opacity-70 flex items-center my-2" style={{gap : "8px"}}>
                        <img src={discord} />
                        <div className="discord-name">barman.ayush</div>
                    </a>
                    <a href="" className="email-link hover:opacity-100 opacity-70 flex items-center my-2" style={{gap : "8px"}}>
                        <img src={email} />
